...
A hand-drawn PFP generator for Pierre the Penguin. Mix head styles and props,
add a caption, then copy or download the finished 500x500 PNG.
...
- Base: `public/characters/base-pierre-bingo.png` (500x500)
- Face: `public/characters/faces/face-mustache-bingo.png` (500x500)
